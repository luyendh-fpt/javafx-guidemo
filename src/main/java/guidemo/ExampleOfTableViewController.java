...
public class ExampleOfTableViewController implements Initializable {
    ...
    @FXML
    private TableColumn<Person, Integer> birthdayColumn;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        birthdayColumn.setCellValueFactory(new PropertyValueFactory<Person, Integer>("age"));
    ...
    public ObservableList<Person> getPeople() {
        ...
        people.add(new Person("Frank", "Sinatra", "20/10/1990", "FrankSinatra.jpg", 50));
        people.add(new Person("Rebecca", "Fergusson", "10/10/1999", "defaultImage.png", 20));
        people.add(new Person("Mr.", "T", "12/12/1999", "defaultImage.png", 10));
